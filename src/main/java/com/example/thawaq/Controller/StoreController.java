...
public class StoreController {
    ...
    @GetMapping("/get-restaurants-you-like/{client}")
    public ResponseEntity findRestaurantYouLike(@PathVariable Client client){
        return ResponseEntity.status(200).body(storeService.getRestaurantsYouLike(client));
    }

    @GetMapping("/get-cafes-you-like/{client}")
    public ResponseEntity findCafesYouLike(@PathVariable Client client){
        return ResponseEntity.status(200).body(storeService.getCafesYouLike(client));
    }

    @GetMapping("/get-restaurants-you-may-like/{client}")
    public ResponseEntity findRestaurantYouMayLike(@PathVariable Client client){
        return ResponseEntity.status(200).body(storeService.getRestaurantYouMayLike(client));
    }

    @GetMapping("/get-cafes-you-may-like/{client}")
    public ResponseEntity findCafesYouMayLike(@PathVariable Client client){
        return ResponseEntity.status(200).body(storeService.getCafesYouMayLike(client));
    }
