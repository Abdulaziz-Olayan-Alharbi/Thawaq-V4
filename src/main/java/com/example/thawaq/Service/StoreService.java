...
//            throw new ApiException("Store not found");
    ...
    public List<Store> getRestaurantsYouLike(Client client){
        List<Store> stores = new ArrayList<>();
    ...
    public List<Store> getCafesYouLike(Client client){
        List<Store> stores = new ArrayList<>();
        List<Favorite> favorites = favoriteRepository.findFavoriteByClient(client);
        for (Favorite favorite : favorites) {
    ...
    public List<Store> getCafesYouMayLike(Client client){
        List<Favorite> favorites = favoriteRepository.findFavoriteByClient(client);
    ...
    public List<Store> getRestaurantYouMayLike(Client client){
        List<Favorite> favorites = favoriteRepository.findFavoriteByClient(client);
        List<Category> categories = new ArrayList<>();
        for (Favorite favorite : favorites) {
            if (favorite.getMenu().getBranch().getStore().getTypeOfActivity().equals("CAFE")){
